...
public interface WACCParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link WACCParser#assignPrimitive}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignPrimitive(@NotNull WACCParser.AssignPrimitiveContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link WACCParser#assignPairArray}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignPairArray(@NotNull WACCParser.AssignPairArrayContext ctx);
	/**
