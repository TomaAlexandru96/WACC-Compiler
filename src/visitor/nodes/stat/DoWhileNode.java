...
public class DoWhileNode extends StatNode<WACCParser.DoWhileStatContext> {

    private StatNode body;
    private ExprNode condition;

    public DoWhileNode(SymbolTable currentST, WACCParser.DoWhileStatContext ctx,
    ...
    public List<Instruction> generateInstructions(CodeGenerator codeGenRef, List<Register> availableRegisters) {
        ...
        instructions.add(new BaseInstruction(Ins.B, new LabelOp(label2)));
