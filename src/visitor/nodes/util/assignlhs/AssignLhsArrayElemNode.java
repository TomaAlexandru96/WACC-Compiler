...
public class AssignLhsArrayElemNode extends AssignLhsNode<WACCParser
        .AssignLhsArrayElemContext> {
    private ArrayElementNode arrayElementNode;

    // assignLhs: arrayElem
    public AssignLhsArrayElemNode(SymbolTable currentST, WACCParser
            .AssignLhsArrayElemContext
    ...
    public List<Instruction> generateInstructions(CodeGenerator codeGenRef,
        ...
        return CodeGenerator.getArrayPointer(codeGenRef, availableRegisters,
                exprNodeList,
